...
public partial class NameSpanParsable
{
   ...
   public static ValidationError? Validate(ReadOnlySpan<char> value, IFormatProvider? provider, out NameSpanParsable? item)
   {
      return value switch
      {
