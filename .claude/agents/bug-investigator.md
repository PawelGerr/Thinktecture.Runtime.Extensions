...
| ValueObject | `Keyed/ComplexValueObjectSourceGeneratorState` | `ValueObjectCodeGenerator` |
...
When your fix involves external APIs (Roslyn, System.Text.Json, xUnit, etc.):
