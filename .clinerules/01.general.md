...
- **[02.feature-dev.md](02.feature-dev.md)**: Source generator architecture, implementing new features, state objects, code generator patterns
- **[05.testing.md](05.testing.md)**: Testing strategy, test organization, frameworks (xUnit, Verify, AwesomeAssertions)
- **[04.review.md](04.review.md)**: Code review checklists, best practices verification, common pitfalls
- **[03.attributes.md](03.attributes.md)**: Complete attribute reference with all properties and configuration options

**When to consult specialized docs:**

- Implementing a new feature → Read 02.feature-dev.md
- Writing or updating tests → Read 05.testing.md
- Reviewing code changes → Read 04.review.md
- Working with attributes or need configuration details → Read 03.attributes.md
