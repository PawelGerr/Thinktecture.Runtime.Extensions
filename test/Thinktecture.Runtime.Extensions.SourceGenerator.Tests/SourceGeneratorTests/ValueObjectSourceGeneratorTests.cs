...
namespace Thinktecture.Tests
{
   ...
   {
      private static readonly Type _type = typeof(TestValueObject);
...
namespace Thinktecture.Tests
{
   ...
   partial class TestValueObject
   {
      public class ValueObjectJsonConverter : JsonConverter<TestValueObject>
      {
...
namespace Thinktecture.Tests
{
   ...
   partial class TestValueObject
   {
      public class ValueObjectNewtonsoftJsonConverter : JsonConverter<TestValueObject?>
      {
         /// <inheritdoc />
         public override TestValueObject? ReadJson(JsonReader reader, Type objectType, TestValueObject? existingValue, bool hasExistingValue, JsonSerializer serializer)
         {
            if (reader is null)
         ...
         /// <inheritdoc />
         public override void WriteJson(JsonWriter writer, TestValueObject? value, JsonSerializer serializer)
         {
            if (value == null)
            {
               writer.WriteNull();
...
namespace Thinktecture.Tests
{
   ...
   partial class TestValueObject
   {
      public class ValueObjectMessagePackFormatter : IMessagePackFormatter<TestValueObject?>
      {
         /// <inheritdoc />
         public TestValueObject? Deserialize(ref MessagePackReader reader, MessagePackSerializerOptions options)
         {
            ...
            try
            {
               ...
               if (validationResult != ValidationResult.Success)
                  throw new MessagePackSerializationException($""Unable to deserialize 'TestValueObject'. Error: {validationResult!.ErrorMessage}."");
         ...
         /// <inheritdoc />
         public void Serialize(ref MessagePackWriter writer, TestValueObject? value, MessagePackSerializerOptions options)
         {
            if(value is null)
            {
               writer.WriteNil();
