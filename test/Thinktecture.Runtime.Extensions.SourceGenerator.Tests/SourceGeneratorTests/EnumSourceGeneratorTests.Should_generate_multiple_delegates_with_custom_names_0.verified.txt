...
namespace Thinktecture.Tests
{
   ...
   {
      private delegate string StringProcessDelegate(string value);
      private delegate int IntProcessDelegate(int value);
      private delegate void BoolProcessDelegate(bool value);
      ...
      private readonly StringProcessDelegate _stringProcessDelegate;
      private readonly IntProcessDelegate _intProcessDelegate;
      private readonly BoolProcessDelegate _boolProcessDelegate;

      private TestEnum(
         string @key,
         StringProcessDelegate @stringProcessDelegate,
         IntProcessDelegate @intProcessDelegate,
         BoolProcessDelegate @boolProcessDelegate)
      {
         ...
         this.Key = @key;
         this._stringProcessDelegate = @stringProcessDelegate;
         this._intProcessDelegate = @intProcessDelegate;
         this._boolProcessDelegate = @boolProcessDelegate;
      ...
      {
         return _stringProcessDelegate(value);
      }

      public partial int Process(int value)
      {
         return _intProcessDelegate(value);
      }

      public partial void Process(bool value)
      {
         _boolProcessDelegate(value);
      }
