...
namespace Thinktecture.Tests
{
   ...
   {
      private delegate string CustomProcessDelegate(int value);
      ...
      private readonly CustomProcessDelegate _customProcessDelegate;

      private TestEnum(
         string @key,
         CustomProcessDelegate @customProcessDelegate)
      {
         ...
         this.Key = @key;
         this._customProcessDelegate = @customProcessDelegate;
      ...
      {
         return _customProcessDelegate(value);
      }
