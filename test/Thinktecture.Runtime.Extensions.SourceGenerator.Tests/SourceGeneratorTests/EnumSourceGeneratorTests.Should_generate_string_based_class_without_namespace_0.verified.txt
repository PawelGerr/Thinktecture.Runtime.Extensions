...
#nullable enable
      ...
      global::System.IEquatable<global::TestEnum?>
   {
      ...
      /// </summary>
      public static global::System.Collections.Generic.IReadOnlyList<global::TestEnum> Items => _lookups.Value.List;
      ...
      private static Lookups GetLookups()
      {
         ...
         var list = new global::System.Collections.Generic.List<global::TestEnum>(2);
...
#endif
         global::System.Collections.Generic.IReadOnlyList<global::TestEnum> List);
   }
