...
");
      ...
      [Fact]
      public void Should_generate_class_with_1_member()
      {
         var source = @"
using System;
using Thinktecture;
   ...
   partial class TestValueType : IEquatable<TestValueType?>
   {
      ...
      public bool Equals(TestValueType? other)
      {
         ...
         return (this.ReferenceField is null ? other.ReferenceField is null : this.ReferenceField.Equals(other.ReferenceField))
             ...
             && (this.ReferenceProperty is null ? other.ReferenceProperty is null : this.ReferenceProperty.Equals(other.ReferenceProperty))
             && this.StructProperty.Equals(other.StructProperty);
      }
      ...
      public override string? ToString()
      {
         return $""{{ ReferenceField = {this.ReferenceField}, StructField = {this.StructField}, ReferenceProperty = {this.ReferenceProperty}, StructProperty = {this.StructProperty} }}"";
      }
   }
}
");
