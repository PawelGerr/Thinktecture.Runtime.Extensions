...
public class JsonAdHocUnionSourceGeneratorTests : SourceGeneratorTestsBase
{
   public JsonAdHocUnionSourceGeneratorTests(ITestOutputHelper output)
      : base(output, 1_000)
   {
   }
   ...
   public async Task Should_generate_attribute_if_attribute_is_missing()
   {
      ...
      var output = GetGeneratedOutput<ObjectFactorySourceGenerator>(source,
                                                                    ".Json",
                                                                    typeof(UnionAttribute).Assembly, typeof(Thinktecture.Text.Json.Serialization.ThinktectureJsonConverter<,,>).Assembly, typeof(System.Text.Json.JsonDocument).Assembly);
