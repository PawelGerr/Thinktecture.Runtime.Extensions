...
public class TryGet
{
   ...
   {
      // Arrange & Act
      var result = AdditionOperatorsCodeGenerator.TryGet(
   ...
   {
      // Arrange & Act
      var result1 = AdditionOperatorsCodeGenerator.TryGet(
         ImplementedOperators.All,
         Thinktecture.CodeAnalysis.OperatorsGeneration.Default,
         out var generator1);

      var result2 = AdditionOperatorsCodeGenerator.TryGet(
         ImplementedOperators.All,
         Thinktecture.CodeAnalysis.OperatorsGeneration.Default,
         out var generator2);
   ...
   {
      // Arrange & Act
      var act = () => AdditionOperatorsCodeGenerator.TryGet(
         ImplementedOperators.All,
   ...
   {
      // Arrange
      AdditionOperatorsCodeGenerator.TryGet(
         ImplementedOperators.All,
         Thinktecture.CodeAnalysis.OperatorsGeneration.Default,
         out var generator);

      // Act & Assert
      generator!.CodeGeneratorName.Should().Be("AdditionOperators-CodeGenerator");
   }
   ...
   public void Should_have_correct_FileNameSuffix()
   {
      ...
      // Act & Assert
      generator!.FileNameSuffix.Should().Be(".AdditionOperators");
   }
}
