...
public class GenerateBaseTypes
{
   ...
   {
      // Arrange
      var state = new AdditionOperatorsStateBuilder()
   ...
   public void Should_generate_interface_when_default_operators_only()
   {
      ...
      // Assert
      sb.ToString().Should().Contain("global::System.Numerics.IAdditionOperators<global::Thinktecture.Tests.TestType, global::Thinktecture.Tests.TestType, global::Thinktecture.Tests.TestType>");
   }
