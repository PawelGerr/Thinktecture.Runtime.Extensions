...
public class TryGet
{
   ...
   {
      // Arrange & Act
      var result = SubtractionOperatorsCodeGenerator.TryGet(
   ...
   {
      // Arrange & Act
      var result1 = SubtractionOperatorsCodeGenerator.TryGet(
         ImplementedOperators.All,
         Thinktecture.CodeAnalysis.OperatorsGeneration.Default,
         out var generator1);

      var result2 = SubtractionOperatorsCodeGenerator.TryGet(
         ImplementedOperators.All,
         Thinktecture.CodeAnalysis.OperatorsGeneration.Default,
         out var generator2);
   ...
   {
      // Arrange & Act
      var act = () => SubtractionOperatorsCodeGenerator.TryGet(
         ImplementedOperators.All,
   ...
   public void Should_have_correct_CodeGeneratorName()
   {
      ...
      // Act & Assert
      generator!.CodeGeneratorName.Should().Be("SubtractionOperators-CodeGenerator");
   }
   ...
   public void Should_have_correct_FileNameSuffix()
   {
      ...
      // Act & Assert
      generator!.FileNameSuffix.Should().Be(".SubtractionOperators");
   }
}
