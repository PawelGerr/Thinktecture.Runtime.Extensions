...
/// <summary>
/// Builder for creating InterfaceCodeGeneratorState instances for testing SubtractionOperatorsCodeGenerator.
/// </summary>
public class SubtractionOperatorsStateBuilder
{
   private ITypeInformation? _type;
   private IMemberInformation? _keyMember;
   private string _createFactoryMethodName = "Create";

   public SubtractionOperatorsStateBuilder WithType(string typeFullyQualified, string name = "TestType", bool isReferenceType = true)
   {
      _type = CreateType(typeFullyQualified, name, isReferenceType);
      return this;
   }

   public SubtractionOperatorsStateBuilder WithReferenceType(string typeFullyQualified, string name = "TestType")
   {
      _type = CreateType(typeFullyQualified, name, isReferenceType: true);
      return this;
   }

   public SubtractionOperatorsStateBuilder WithValueType(string typeFullyQualified, string name = "TestType")
   {
      _type = CreateType(typeFullyQualified, name, isReferenceType: false);
      return this;
   }

   public SubtractionOperatorsStateBuilder WithStringKeyMember(string name = "Value", bool isReferenceType = true)
   {
      _keyMember = CreateKeyMember(name, "global::System.String", SpecialType.System_String, isReferenceType);
      return this;
   }

   public SubtractionOperatorsStateBuilder WithIntKeyMember(string name = "Value", bool isReferenceType = false)
   {
      _keyMember = CreateKeyMember(name, "global::System.Int32", SpecialType.System_Int32, isReferenceType);
      return this;
   }

   public SubtractionOperatorsStateBuilder WithByteKeyMember(string name = "Value", bool isReferenceType = false)
   {
      _keyMember = CreateKeyMember(name, "global::System.Byte", SpecialType.System_Byte, isReferenceType);
      return this;
   }

   public SubtractionOperatorsStateBuilder WithDecimalKeyMember(string name = "Value", bool isReferenceType = false)
   {
      _keyMember = CreateKeyMember(name, "global::System.Decimal", SpecialType.System_Decimal, isReferenceType);
      return this;
   }

   public SubtractionOperatorsStateBuilder WithKeyMember(string name, string typeFullyQualified, SpecialType specialType = SpecialType.None, bool isReferenceType = false)
   {
      _keyMember = CreateKeyMember(name, typeFullyQualified, specialType, isReferenceType);
      return this;
   }

   public SubtractionOperatorsStateBuilder WithUnconstrainedTypeParameterKeyMember(string name = "Value")
   {
      _keyMember = CreateUnconstrainedTypeParameterKeyMember(name);
      return this;
   }

   public SubtractionOperatorsStateBuilder WithCreateFactoryMethodName(string name)
   {
