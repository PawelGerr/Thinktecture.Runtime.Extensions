...
";
      ...
      // Assert
      result.Should().NotBeNull();
      result!.JsonIgnoreCondition.Should().Be(Thinktecture.Json.JsonIgnoreCondition.WhenWritingNull);
   }
...
";
      ...
      var factory = TypedMemberStateFactory.Create(compilation);
      var type = GetTypeSymbol(compilation, "Test.TestClass");
      var field = type.GetMembers("_field").FirstOrDefault() as IFieldSymbol;
