...
";
      ...
      // Assert
      result.Should().NotBeNull();
      result!.JsonIgnoreCondition.Should().Be(Thinktecture.Json.JsonIgnoreCondition.Always);
   }
...
";
      ...
      // Assert
      result.Should().NotBeNull();
      result!.JsonIgnoreCondition.Should().Be(Thinktecture.Json.JsonIgnoreCondition.WhenWritingDefault);
   }
...
";
      ...
      // Assert
      result.Should().NotBeNull();
      result!.JsonIgnoreCondition.Should().Be(Thinktecture.Json.JsonIgnoreCondition.Never);
   }
}
