...
public class TryGet
{
   ...
   {
      // Arrange & Act
      var result = DivisionOperatorsCodeGenerator.TryGet(
   ...
   {
      // Arrange & Act
      var result1 = DivisionOperatorsCodeGenerator.TryGet(
         ImplementedOperators.All,
         Thinktecture.CodeAnalysis.OperatorsGeneration.Default,
         out var generator1);

      var result2 = DivisionOperatorsCodeGenerator.TryGet(
         ImplementedOperators.All,
         Thinktecture.CodeAnalysis.OperatorsGeneration.Default,
         out var generator2);
   ...
   {
      // Arrange & Act
      var act = () => DivisionOperatorsCodeGenerator.TryGet(
         ImplementedOperators.All,
   ...
   public void Should_have_correct_CodeGeneratorName()
   {
      ...
      // Act & Assert
      generator!.CodeGeneratorName.Should().Be("DivisionOperators-CodeGenerator");
   }
   ...
   public void Should_have_correct_FileNameSuffix()
   {
      ...
      // Act & Assert
      generator!.FileNameSuffix.Should().Be(".DivisionOperators");
   }
}
