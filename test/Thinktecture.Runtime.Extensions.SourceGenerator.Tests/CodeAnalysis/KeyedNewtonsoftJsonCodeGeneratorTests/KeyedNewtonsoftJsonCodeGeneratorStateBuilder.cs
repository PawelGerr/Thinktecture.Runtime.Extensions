...
/// <summary>
/// Builder for creating KeyedSerializerGeneratorState instances for testing KeyedNewtonsoftJsonCodeGenerator.
/// </summary>
public class KeyedNewtonsoftJsonCodeGeneratorStateBuilder
{
   ...
   public KeyedNewtonsoftJsonCodeGeneratorStateBuilder WithType(
   ...
   public KeyedNewtonsoftJsonCodeGeneratorStateBuilder AsStruct()
   {
      _isReferenceType = false;
      return this;
   }

   public KeyedNewtonsoftJsonCodeGeneratorStateBuilder AsClass()
   {
      _isReferenceType = true;
      return this;
   }

   public KeyedNewtonsoftJsonCodeGeneratorStateBuilder AsRecord()
   {
      _isRecord = true;
      return this;
   }

   public KeyedNewtonsoftJsonCodeGeneratorStateBuilder WithTypeWithoutNamespace(
   ...
   public KeyedNewtonsoftJsonCodeGeneratorStateBuilder WithNestedType(
   ...
   public KeyedNewtonsoftJsonCodeGeneratorStateBuilder WithStringKeyMember(string name = "Key")
   {
      _keyMember = CreateKeyMember(name, "global::System.String", SpecialType.System_String);
      return this;
   }

   public KeyedNewtonsoftJsonCodeGeneratorStateBuilder WithIntKeyMember(string name = "Key")
   {
      _keyMember = CreateKeyMember(name, "global::System.Int32", SpecialType.System_Int32);
      return this;
   }

   public KeyedNewtonsoftJsonCodeGeneratorStateBuilder WithGuidKeyMember(string name = "Key")
   {
      _keyMember = CreateKeyMember(name, "global::System.Guid", SpecialType.None);
      return this;
   }

   public KeyedNewtonsoftJsonCodeGeneratorStateBuilder WithDecimalKeyMember(string name = "Key")
   {
      _keyMember = CreateKeyMember(name, "global::System.Decimal", SpecialType.System_Decimal);
      return this;
   }

   public KeyedNewtonsoftJsonCodeGeneratorStateBuilder WithoutKeyMember()
   {
      _keyMember = null;
      return this;
   }

   public KeyedNewtonsoftJsonCodeGeneratorStateBuilder WithCustomFactory(
      string typeFullyQualified,
      SpecialType specialType = SpecialType.None,
      global::Thinktecture.CodeAnalysis.SerializationFrameworks useForSerialization = global::Thinktecture.CodeAnalysis.SerializationFrameworks.NewtonsoftJson)
   {
   ...
   public KeyedNewtonsoftJsonCodeGeneratorStateBuilder WithStringCustomFactory(
      global::Thinktecture.CodeAnalysis.SerializationFrameworks useForSerialization = global::Thinktecture.CodeAnalysis.SerializationFrameworks.NewtonsoftJson)
   {
   ...
   public KeyedNewtonsoftJsonCodeGeneratorStateBuilder WithValidationError(string typeFullyQualified)
   {
      _validationError = new ValidationErrorState(typeFullyQualified);
      return this;
   }

   public KeyedNewtonsoftJsonCodeGeneratorStateBuilder WithSerializationFrameworks(global::Thinktecture.CodeAnalysis.SerializationFrameworks frameworks)
   {
