...
";
         var output = GetGeneratedOutput<EnumSourceGenerator>(source, typeof(IEnum<>).Assembly);
...
";
      ...
      [Fact]
      public void Should_generate_simple_class_which_implements_IEnum_if_IEnum_is_alias()
      {
         var source = @"
using System;
using EnumAlias = Thinktecture.IEnum<string>;

namespace Thinktecture.EnumLikeClass
{
	public partial class TestEnum : EnumAlias
	{
      public static readonly TestEnum Item1 = new(""Item1"");
      public static readonly TestEnum Item2 = new(""Item2"");
   }
...
";
         var output = GetGeneratedOutput<EnumSourceGenerator>(source, typeof(IValidatableEnum<>).Assembly);
...
";
         var output = GetGeneratedOutput<EnumJsonConverterSourceGenerator>(source, typeof(IEnum<>).Assembly, typeof(Thinktecture.Text.Json.Serialization.EnumJsonConverter<,>).Assembly, typeof(System.Text.Json.JsonDocument).Assembly);
...
";
         var output = GetGeneratedOutput<EnumNewtonsoftJsonConverterSourceGenerator>(source, typeof(IEnum<>).Assembly, typeof(Json.EnumJsonConverter).Assembly, typeof(Newtonsoft.Json.JsonToken).Assembly);
...
";
         var output = GetGeneratedOutput<EnumMessagePackFormatterSourceGenerator>(source, typeof(IEnum<>).Assembly, typeof(EnumMessagePackFormatter<,>).Assembly, typeof(MessagePackFormatterAttribute).Assembly);
