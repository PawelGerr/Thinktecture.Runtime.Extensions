...
";
      ...
      var derivedCompilation = CreateCompilation(derivedAssemblySrc, "TestLib", ignoreCompilationErrors: true, additionalReferences: baseReference);
...
";
   ...
   [Fact]
   public void Should_return_private_protected_constructor_from_different_assembly_with_internals_visible_to()
   {
      var baseAssemblySrc = @"
using System.Runtime.CompilerServices;
