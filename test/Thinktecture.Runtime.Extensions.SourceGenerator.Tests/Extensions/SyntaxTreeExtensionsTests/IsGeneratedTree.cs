...
public class IsGeneratedTree
{
   ...
   {
      // Arrange
      var syntaxTree = CSharpSyntaxTree.ParseText("", path: null!);
      var cancellationToken = CancellationToken.None;
   ...
   {
      // Arrange
      var syntaxTree = CSharpSyntaxTree.ParseText("", path: "My.Complex.File.Name.g.cs");
      var cancellationToken = CancellationToken.None;
   ...
   {
      // Arrange
      var syntaxTree = CSharpSyntaxTree.ParseText("", path: "C:\\folder.g.cs\\MyClass.cs");
      var cancellationToken = CancellationToken.None;
   ...
   public void Returns_true_for_very_long_file_path_with_generated_extension()
   {
      ...
      var syntaxTree = CSharpSyntaxTree.ParseText("", path: longPath);
      var cancellationToken = CancellationToken.None;
   ...
   {
      // Arrange
      var syntaxTree = CSharpSyntaxTree.ParseText("", path: "/usr/local/src/File.g.cs");
      var cancellationToken = CancellationToken.None;
   ...
   {
      // Arrange
      var syntaxTree = CSharpSyntaxTree.ParseText("", path: "C:\\Users\\Developer\\Source\\File.designer.cs");
      var cancellationToken = CancellationToken.None;
   ...
   {
      // Arrange
      var syntaxTree = CSharpSyntaxTree.ParseText("", path: "File..g.cs");
      var cancellationToken = CancellationToken.None;
   ...
   {
      // Arrange
      var syntaxTree = CSharpSyntaxTree.ParseText("", path: "My File (Special).g.cs");
      var cancellationToken = CancellationToken.None;
