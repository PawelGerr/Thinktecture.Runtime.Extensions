...
public class IsKeyedValueObjectAttribute : CompilationTestBase
{
   [Fact]
   public void Returns_true_for_ValueObjectAttribute()
   {
      var src = @"
using Thinktecture;
...
";
      ...
      // Get the attribute type from the applied attribute
      var type = GetTypeSymbol(compilation, "Test.MyValueObject");
      var attribute = type.GetAttributes().First();
      var attributeType = attribute.AttributeClass;

      var result = attributeType.IsKeyedValueObjectAttribute();

      result.Should().BeTrue();
   }

   [Fact]
   public void Returns_false_for_ComplexValueObjectAttribute()
   {
      var src = @"
using Thinktecture;
...
";
   ...
   public void Returns_false_for_null()
   {
      ...
      var result = type.IsKeyedValueObjectAttribute();
...
";
      ...
      var result = errorType.IsKeyedValueObjectAttribute();
...
";
      var compilation = CreateCompilation(src);
      var type = GetTypeSymbol(compilation, "WrongNamespace.ValueObjectAttribute");
