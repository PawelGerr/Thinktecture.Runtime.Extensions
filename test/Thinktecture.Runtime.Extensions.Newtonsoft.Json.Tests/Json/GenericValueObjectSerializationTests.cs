   ...
   public class IntBased
   {
      public class Serialization
      {
         ...
         public void Should_serialize_with_different_type_arguments()
         {
            ...
            var stringJson = JsonConvert.SerializeObject(stringInstance);
            var intJson = JsonConvert.SerializeObject(intInstance);
      ...
      public class Deserialization
      {
         ...
         public void Should_deserialize_from_int_value(int value)
         {
            ...
            var obj = JsonConvert.DeserializeObject<ValueObject_Generic_IntBased<string>>(json);
         ...
         public void Should_deserialize_with_different_type_arguments()
         {
            ...
            var stringInstance = JsonConvert.DeserializeObject<ValueObject_Generic_IntBased<string>>(json);
            var intInstance = JsonConvert.DeserializeObject<ValueObject_Generic_IntBased<int>>(json);
         ...
         {
            var json = "42";
            var obj = JsonConvert.DeserializeObject<StructValueObject_Generic_IntBased<string>>(json);
      ...
      public class RoundTrip
      {
         ...
         public void Should_round_trip_successfully(int value)
         {
            ...
            var deserialized = JsonConvert.DeserializeObject<ValueObject_Generic_IntBased<string>>(json);
         ...
         public void Should_round_trip_with_different_type_arguments()
         {
            ...
            var stringJson = JsonConvert.SerializeObject(stringOriginal);
            var intJson = JsonConvert.SerializeObject(intOriginal);

            var stringDeserialized = JsonConvert.DeserializeObject<ValueObject_Generic_IntBased<string>>(stringJson);
            var intDeserialized = JsonConvert.DeserializeObject<ValueObject_Generic_IntBased<int>>(intJson);
         ...
         public void Should_round_trip_struct_successfully()
         {
            ...
            var json = JsonConvert.SerializeObject(original);
            var deserialized = JsonConvert.DeserializeObject<StructValueObject_Generic_IntBased<string>>(json);
   ...
   public class StringBased
   {
      public class Serialization
      {
         ...
         public void Should_serialize_to_string_value(string value)
         {
            ...
            json.Should().Be(JsonConvert.SerializeObject(value));
         }
         ...
         public void Should_serialize_with_different_type_arguments()
         {
            ...
            var stringJson = JsonConvert.SerializeObject(stringInstance);
            var objectJson = JsonConvert.SerializeObject(objectInstance);
      ...
      public class Deserialization
      {
         ...
         public void Should_deserialize_from_string_value(string value)
         {
            ...
            var obj = JsonConvert.DeserializeObject<ValueObject_Generic_StringBased<object>>(json);
         ...
         public void Should_deserialize_with_different_type_arguments()
         {
            ...
            var stringInstance = JsonConvert.DeserializeObject<ValueObject_Generic_StringBased<string>>(json);
            var objectInstance = JsonConvert.DeserializeObject<ValueObject_Generic_StringBased<object>>(json);
      ...
      public class RoundTrip
      {
         ...
         public void Should_round_trip_successfully(string value)
         {
            ...
            var json = JsonConvert.SerializeObject(original);
            var deserialized = JsonConvert.DeserializeObject<ValueObject_Generic_StringBased<object>>(json);
         ...
         public void Should_round_trip_with_different_type_arguments()
         {
            ...
            var stringJson = JsonConvert.SerializeObject(stringOriginal);
            var objectJson = JsonConvert.SerializeObject(objectOriginal);

            var stringDeserialized = JsonConvert.DeserializeObject<ValueObject_Generic_StringBased<string>>(stringJson);
            var objectDeserialized = JsonConvert.DeserializeObject<ValueObject_Generic_StringBased<object>>(objectJson);
   ...
   public class GuidBased
   {
      public class Serialization
      {
         ...
         public void Should_serialize_to_guid_value()
         {
            ...
            json.Should().Be(JsonConvert.SerializeObject(guid));
         }
         ...
         public void Should_serialize_with_different_type_arguments()
         {
            ...
            var expectedJson = JsonConvert.SerializeObject(guid);
      ...
      public class Deserialization
      {
         ...
         public void Should_deserialize_from_guid_value()
         {
            ...
            var obj = JsonConvert.DeserializeObject<ValueObject_Generic_GuidBased<string>>(json);
         ...
         public void Should_deserialize_with_different_type_arguments()
         {
            ...
            var stringInstance = JsonConvert.DeserializeObject<ValueObject_Generic_GuidBased<string>>(json);
            var intInstance = JsonConvert.DeserializeObject<ValueObject_Generic_GuidBased<int>>(json);
      ...
      public class RoundTrip
      {
         ...
         public void Should_round_trip_successfully()
         {
            ...
            var json = JsonConvert.SerializeObject(original);
            var deserialized = JsonConvert.DeserializeObject<ValueObject_Generic_GuidBased<string>>(json);
         ...
         public void Should_round_trip_with_different_type_arguments()
         {
            ...
            var stringDeserialized = JsonConvert.DeserializeObject<ValueObject_Generic_GuidBased<string>>(stringJson);
            var intDeserialized = JsonConvert.DeserializeObject<ValueObject_Generic_GuidBased<int>>(intJson);
