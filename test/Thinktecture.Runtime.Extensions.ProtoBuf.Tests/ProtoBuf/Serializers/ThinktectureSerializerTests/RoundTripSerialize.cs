...
public class RoundTripSerialize
{
   ...
   {
      RoundTrip(TestSmartEnum_Struct_IntBased_Validatable.Value1);
      RoundTrip(TestSmartEnum_Struct_StringBased_Validatable.Value1);
      RoundTrip(TestSmartEnum_Class_IntBased.Value1);
      RoundTrip(TestSmartEnum_Class_StringBased.Value1);
   }
