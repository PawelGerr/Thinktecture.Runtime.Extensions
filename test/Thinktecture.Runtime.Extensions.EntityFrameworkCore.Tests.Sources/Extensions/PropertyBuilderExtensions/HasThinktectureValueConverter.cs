...
{
   public class HasThinktectureValueConverter : IDisposable
   {
         ...
         var entity = new TestEntity_with_Enum_and_ValueObjects
                      {
                         ...
                         StringBasedStructValueObject = StringBasedStructValueObject.Create("propertytest1"),
                         TestComplexValueObject_ObjectFactory_and_Constructor = TestComplexValueObject_ObjectFactory_and_Constructor.Create("propertyprop1", "propertyprop2")
                      };
         ...
         var entity = new TestEntity_with_Enum_and_ValueObjects
                      {
                         ...
                         StringBasedStructValueObject = StringBasedStructValueObject.Create("propertytest2"),
                         TestComplexValueObject_ObjectFactory_and_Constructor = TestComplexValueObject_ObjectFactory_and_Constructor.Create("propertyprop3", "propertyprop4")
                      };
         ...
         var entity = new TestEntity_with_Enum_and_ValueObjects
                      {
                         ...
                         StringBasedStructValueObject = StringBasedStructValueObject.Create("propertytest3"),
                         TestComplexValueObject_ObjectFactory_and_Constructor = TestComplexValueObject_ObjectFactory_and_Constructor.Create("propertyprop5", "propertyprop6")
                      };
         ...
         var entity = new TestEntity_with_Enum_and_ValueObjects
                      {
                         ...
                         StringBasedStructValueObject = StringBasedStructValueObject.Create("propertytest4"),
                         TestComplexValueObject_ObjectFactory_and_Constructor = TestComplexValueObject_ObjectFactory_and_Constructor.Create("propertyprop7", "propertyprop8")
                      };
         ...
         var entity1 = new TestEntity_with_Enum_and_ValueObjects
                       {
                          ...
                          SmartEnum_StringBased = SmartEnum_StringBased.Item1,
                          SmartEnum_IntBased = SmartEnum_IntBased.Item1,
                          StringBasedStructValueObject = StringBasedStructValueObject.Create("propertytest5"),
                          TestComplexValueObject_ObjectFactory_and_Constructor = TestComplexValueObject_ObjectFactory_and_Constructor.Create("propertyprop9", "propertyprop10")
                       };
         ...
         var entity2 = new TestEntity_with_Enum_and_ValueObjects
                       {
                          ...
                          SmartEnum_StringBased = SmartEnum_StringBased.Item2,
                          SmartEnum_IntBased = SmartEnum_IntBased.Item2,
                          StringBasedStructValueObject = StringBasedStructValueObject.Create("propertytest6"),
                          TestComplexValueObject_ObjectFactory_and_Constructor = TestComplexValueObject_ObjectFactory_and_Constructor.Create("propertyprop11", "propertyprop12")
                       };
         ...
         var entity = new TestEntity_with_Enum_and_ValueObjects
                      {
                         ...
                         SmartEnum_StringBased = SmartEnum_StringBased.Item1,
                         SmartEnum_IntBased = SmartEnum_IntBased.Item1,
                         StringBasedStructValueObject = StringBasedStructValueObject.Create("propertytest7"),
                         TestComplexValueObject_ObjectFactory_and_Constructor = TestComplexValueObject_ObjectFactory_and_Constructor.Create("propertyprop13", "propertyprop14")
                      };
         ...
         var entities = new[]
                        {
                           new TestEntity_with_Enum_and_ValueObjects
                           {
                              ...
                              SmartEnum_StringBased = SmartEnum_StringBased.Item1,
                              SmartEnum_IntBased = SmartEnum_IntBased.Item1,
                              StringBasedStructValueObject = StringBasedStructValueObject.Create("propertytest8"),
                              TestComplexValueObject_ObjectFactory_and_Constructor = TestComplexValueObject_ObjectFactory_and_Constructor.Create("propertyprop15", "propertyprop16")
                           },
                           new TestEntity_with_Enum_and_ValueObjects
                           {
                              Id = Guid.NewGuid(),
                              SmartEnum_StringBased = SmartEnum_StringBased.Item2,
                              SmartEnum_IntBased = SmartEnum_IntBased.Item2,
                              StringBasedStructValueObject = StringBasedStructValueObject.Create("propertytest9"),
                              TestComplexValueObject_ObjectFactory_and_Constructor = TestComplexValueObject_ObjectFactory_and_Constructor.Create("propertyprop17", "propertyprop18")
                           },
                           new TestEntity_with_Enum_and_ValueObjects
                           {
                              Id = Guid.NewGuid(),
                              SmartEnum_StringBased = SmartEnum_StringBased.Item1,
                              SmartEnum_IntBased = SmartEnum_IntBased.Item3,
                              StringBasedStructValueObject = StringBasedStructValueObject.Create("propertytest10"),
                              TestComplexValueObject_ObjectFactory_and_Constructor = TestComplexValueObject_ObjectFactory_and_Constructor.Create("propertyprop19", "propertyprop20")
                           }
                        };
