...
public class FixedSmartEnumMaxLengthStrategyTests
{
   ...
   {
      var act = () => new FixedSmartEnumMaxLengthStrategy(0);
   ...
   {
      var act = () => new FixedSmartEnumMaxLengthStrategy(-1);
   ...
   {
      var strategy = new FixedSmartEnumMaxLengthStrategy(50, overwriteExistingMaxLength: true);
   ...
   {
      var strategy = new FixedSmartEnumMaxLengthStrategy(100);
   ...
   public void GetMaxLength_should_return_None_for_non_string_key_type()
   {
      ...
      var result = strategy.GetMaxLength(typeof(object), typeof(int), items);

      result.IsSet.Should().BeFalse();
   }

   [Fact]
   public void GetMaxLength_should_be_independent_of_items()
   {
      var strategy = new FixedSmartEnumMaxLengthStrategy(50);
      var items = new List<ISmartEnumItem>
                  {
   ...
   [Fact]
   public void GetMaxLength_should_work_with_empty_items_collection()
   {
      var strategy = new FixedSmartEnumMaxLengthStrategy(50);
   ...
   {
      var strategy = new FixedSmartEnumMaxLengthStrategy(int.MaxValue);
      var items = new List<ISmartEnumItem>();
   ...
   {
      var strategy = new FixedSmartEnumMaxLengthStrategy(1);
      var items = new List<ISmartEnumItem>();
   ...
   {
      var strategy1 = new FixedSmartEnumMaxLengthStrategy(50, overwriteExistingMaxLength: true);
      var strategy2 = new FixedSmartEnumMaxLengthStrategy(50, overwriteExistingMaxLength: true);
   ...
   {
      var strategy1 = new FixedSmartEnumMaxLengthStrategy(50);
      var strategy2 = new FixedSmartEnumMaxLengthStrategy(100);
   ...
   {
      var strategy1 = new FixedSmartEnumMaxLengthStrategy(50, overwriteExistingMaxLength: false);
      var strategy2 = new FixedSmartEnumMaxLengthStrategy(50, overwriteExistingMaxLength: true);
