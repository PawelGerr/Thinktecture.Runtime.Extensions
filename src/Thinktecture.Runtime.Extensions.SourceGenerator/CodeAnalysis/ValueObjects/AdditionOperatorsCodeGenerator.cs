...
public sealed class AdditionOperatorsCodeGenerator : IInterfaceCodeGenerator
{
   ...
   {
      sb.Append(@$"
      global::System.Numerics.IAdditionOperators<{type.TypeFullyQualified}, {type.TypeFullyQualified}, {type.TypeFullyQualified}>");

      if (_withKeyTypeOverloads)
      {
         sb.Append(@$",
      global::System.Numerics.IAdditionOperators<{type.TypeFullyQualified}, {keyMember.TypeFullyQualified}, {type.TypeFullyQualified}>");
      }
   }
