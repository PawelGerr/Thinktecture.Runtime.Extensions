...
{
   public class ValueTypeSourceGeneratorState : IEquatable<ValueTypeSourceGeneratorState>
   {
...
#pragma warning restore CS8775
      ...
      public ValueTypeSourceGeneratorState(SemanticModel model, INamedTypeSymbol type, AttributeData valueTypeAttribute)
      {
      ...
      public bool Equals(ValueTypeSourceGeneratorState? other)
      {
      ...
      public override bool Equals(object? obj)
      {
         ...
         if (obj.GetType() != GetType())
            return false;
         return Equals((ValueTypeSourceGeneratorState)obj);
      }
