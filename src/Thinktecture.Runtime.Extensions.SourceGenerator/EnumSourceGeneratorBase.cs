   ...
   public abstract class EnumSourceGeneratorBase : ISourceGenerator
   {
      ...
      public void Execute(GeneratorExecutionContext context)
      {
         ...
         foreach (var enumDeclaration in receiver.Enums)
         {
            ...
            var enumType = model.GetDeclaredSymbol(enumDeclaration.TypeDeclarationSyntax);
            ...
            if (enumInterface is not null)
            {
               ...
               {
                  context.AddSource($"{enumDeclaration.TypeDeclarationSyntax.Identifier}_Generated.cs", $@"// <auto-generated />
#nullable enable
{generatedCode}");
               }
            }
