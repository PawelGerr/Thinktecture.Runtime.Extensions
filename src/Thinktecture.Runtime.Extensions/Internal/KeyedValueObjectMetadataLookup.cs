...
public static class KeyedValueObjectMetadataLookup
{
   ...
   /// </summary>
   /// <param name="type">Type to search for <see cref="KeyedValueObjectMetadata"/> for.</param>
   /// <returns>An instance of <see cref="KeyedValueObjectMetadata"/> if the <paramref name="type"/> is an value object; otherwise <c>null</c>.</returns>
